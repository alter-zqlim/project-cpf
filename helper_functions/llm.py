...
def improved_question(question):
    ...
    <user-query>The dataset lists tenders that have been awarded by Singapore government agencies from 2019 to 2024. Each tender lists details of the agency that called the tender, a description of the tender, the status and amount awarded and the supplier the tender was awarded to. {question} List the steps taken to answer the query.</user-query>
    """)

...
st.markdown(
    ...
    3. Users are able to apply queries on the filtered set of data.  
    4. A Crew is set up with Agents and Task. The Crew will analyse the filtered data, the user query, and output its raw analysis.
    """
)
